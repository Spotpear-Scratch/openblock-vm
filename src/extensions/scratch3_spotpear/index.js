 ...
 * https://github.com/LLK/scratch-spotpear-firmware/blob/master/protocol.md
 * @readonly
 * @enum {number}
 */
const BLECommand = {
...
/**
 * Manage communication with a spotpear peripheral over a Scrath Link client socket.
 */
class spotpear {
    ...
    _onMessage (base64) {
        ...
        this._sensors.buttonA = data[0];
        this._sensors.buttonB = data[1];

        this._sensors.touchPins[0] = data[2];
        this._sensors.touchPins[1] = data[3];
        this._sensors.touchPins[2] = data[4];
        this._sensors.touchPins[3] = data[5];
        this._sensors.touchPins[4] = data[6];
 ...
 * @enum {string}
 */
const spotpearPinState = {
    ON: 'on',
    OFF: 'off'
};

/**
 * Scratch 3.0 blocks to interact with a spotpear peripheral.
 */
class Scratch3spotpearBlocks {
    ...
    get BUTTONS_MENU () {
        return [
            {
                text: 'A',
                value: spotpearButtons.A
            },
            {
                text: 'B',
                value: spotpearButtons.B
            },
            {
                text: formatMessage({
                    id: 'spotpear.buttonsMenu.any',
                    default: 'any',
                    description: 'label for "any" element in button picker for micro:bit extension'
                }),
                value: spotpearButtons.ANY
            }
        ];
    }
    ...
    get PIN_STATE_MENU () {
        return [
            {
                text: formatMessage({
                    id: 'spotpear.pinStateMenu.on',
                    default: 'on',
                    description: 'label for on element in pin state picker for micro:bit extension'
                }),
                value: spotpearPinState.ON
            },
            {
                text: formatMessage({
                    id: 'spotpear.pinStateMenu.off',
                    default: 'off',
                    description: 'label for off element in pin state picker for micro:bit extension'
                }),
                value: spotpearPinState.OFF
            }
        ];
    }
    ...
    constructor (runtime) {
        ...
        this._peripheral = new spotpear(this.runtime, Scratch3spotpearBlocks.EXTENSION_ID);
    }
    ...
    getInfo () {
        return [{
            id: Scratch3spotpearBlocks.EXTENSION_ID,
            name: Scratch3spotpearBlocks.EXTENSION_NAME,
            ...
            blocks: [
                {
                    ...
                    arguments: {
                        BTN: {
                            ...
                            menu: 'buttons',
                            defaultValue: spotpearButtons.A
                        }
                    }
                },
                {
                    ...
                    arguments: {
                        TEXT: {
                            ...
                            defaultValue: formatMessage({
                                id: 'spotpear.defaultTextToDisplay',
                                default: 'Hello!',
...
module.exports = Scratch3spotpearBlocks;
